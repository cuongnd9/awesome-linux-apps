...
- [Frinika](http://www.frinika.com/) - Free, complete music workstation software for Linux, Windows, Mac OSX and other operating systems running Java.
...
- [Chromium](https://github.com/chromium/chromium) - Chromium is an open-source browser project that aims to build a safer, faster, and more stable way for all Internet users to experience the web. 👏
...
- [Tor](https://www.torproject.org/projects/torbrowser.html.en) - Containing everything you need to safely browse the Internet.
...
- [Viber](https://www.viber.com) - VoIP application and Skype contender – it offers text, audio, gif, and video services as well as Unity integration.
...
- [Inkscape](https://github.com/inkscape/inkscape) - Professional vector graphics editor for Windows, Mac OS X and Linux. It's free and open source. 👏
...
- [Mailspring](https://github.com/Foundry376/Mailspring) - Best mail client for Mac, Linux, and Windows. 👏
...
- [Amarok](https://github.com/KDE/amarok) - Powerful music player for Linux, Unix and Windows with an intuitive interface. 👏
...
- [BlueFish](http://bluefish.openoffice.nl/index.html) - Powerful editor targeted towards programmers and webdevelopers, with many options to write websites, scripts and programming code.
...
- [Visual Studio Code](https://github.com/Microsoft/vscode) - Free. Open source. Runs everywhere. 👏

## Video

- [Kodi](https://github.com/xbmc/xbmc) - Free and open source media player application developed by the XBMC/Kodi Foundation, a non-profit technology consortium. 👏
...
- [VLC](https://github.com/videolan/vlc) - Free and open source cross-platform multimedia player and framework that plays most multimedia files as well as DVDs, Audio CDs, VCDs, and various streaming protocols. 👏
